# -*- coding: utf-8 -*-
"""
Created on Tue Feb 12 18:04:48 2019
...
pos = nx.spring_layout(G, scale=0.5, dim=2)
size = [1000, 1000, 1000, 1000, 1000, 1000, 1000] 
color=["#A0CBE2", "#A0CBE2", "#A0CBE2", "#A0CBE2", "#A0CBE2", "#A0CBE2"]
nx.draw(G,pos, with_labels=True, edge_color='black', node_size=size, node_color=color, font_size=20, width=7)

nx.draw_networkx_edges(G, pos,  edge_color='green', label="S", arrowstyle='-|>', arrows=True, width=3)

plt.axis('off')
plt.savefig("MDirigidoCiclico.eps") 
plt.show()